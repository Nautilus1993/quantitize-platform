...
if __name__ == "__main__":
    ...
    T_int_weight = read_int_bin_file_with_numpy("./WT/T32_T32_L02_s07_conv_wt.bin", 8)
    int_weight = demap_of_weight (T_int_weight, 160, 416, 1, 1)

    new_int_weight = np.zeros((160,480,1,1))
    for i in range(160):
        for j in range(480):
            if(j < 80):
    ...
    T_new_int_weight = parallel_weight(new_int_weight, 160, 480, 1, 1)
    np.savetxt("T32_T32_L02_s07_conv_wt.txt", T_new_int_weight.flatten(), fmt='%f')
    INT_txt_to_bin ("T32_T32_L02_s07_conv_wt.txt", "T32_T32_L02_s07_conv_wt.bin", 8)
